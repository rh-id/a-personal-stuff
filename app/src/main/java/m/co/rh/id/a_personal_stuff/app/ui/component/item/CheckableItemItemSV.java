...
public class CheckableItemItemSV extends StatefulView<Activity> implements RequireComponent<Provider>, View.OnClickListener {
    ...
    private transient OnItemChecked mOnItemChecked;

    public CheckableItemItemSV() {
    ...
    protected View createView(Activity activity, ViewGroup container) {
        View rootLayout = activity.getLayoutInflater().inflate(R.layout.checkable_item_item, container, false);
        ...
        CheckBox checkSelectButton = rootLayout.findViewById(R.id.button_check_select);
        mRxDisposer.add("createView_onSelected",
                mSelected.getSubject().observeOn(AndroidSchedulers.mainThread())
                        .subscribe(checkSelectButton::setChecked));
    ...
    public void onClick(View view) {
        ...
        if (mOnItemChecked != null) {
            mOnItemChecked.onItemChecked(mItemState.getValue(), selected);
        }
    }
    ...
    public interface OnItemChecked {
        void onItemChecked(ItemState itemState, boolean checked);
    }
}
