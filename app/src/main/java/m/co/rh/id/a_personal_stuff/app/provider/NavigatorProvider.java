...
import m.co.rh.id.a_personal_stuff.app.ui.page.ItemMultiSelectPage;
...
import m.co.rh.id.a_personal_stuff.app.ui.page.AppItemChecklistDetailPage;
import m.co.rh.id.a_personal_stuff.app.ui.page.ItemChecklistAddPage;
...
public class NavigatorProvider implements ProviderDisposable {
    ...
    private Navigator setupMainActivityNavigator() {
        ...
        navMap.put(Routes.ITEM_MULTI_SELECT_PAGE, (args, activity) -> new ItemMultiSelectPage());
        ...
        navMap.put(Routes.ITEM_PURCHASES_PAGE, (args, activity) -> new ItemPurchasesPage());
        navMap.put(Routes.ITEM_PURCHASE_DETAIL_PAGE, (args, activity) -> new ItemPurchaseDetailPage());
        navMap.put(Routes.ITEM_STOCK_MOVEMENTS_PAGE, (args, activity) -> new ItemStockMovementsPage());
        ...
        navMap.put(Routes.ITEM_CHECKLISTS_PAGE, (args, activity) -> new ItemChecklistsPage(ItemChecklistsPage.Args.of(args)));
        navMap.put(Routes.ITEM_CHECKLIST_ADD_PAGE, (args, activity) -> new ItemChecklistAddPage());
        navMap.put(Routes.ITEM_CHECKLIST_DETAIL_PAGE, (args, activity) -> new AppItemChecklistDetailPage());
        navMap.put(Routes.ITEM_CHECKLIST_SELECT_PAGE, (args, activity) -> new ItemChecklistSelectPage(ItemChecklistSelectPage.Args.of(args)));
        ...
        navMap.put(Routes.COMMON_INPUT_DIALOG, (args, activity) -> new InputSVDialog());
